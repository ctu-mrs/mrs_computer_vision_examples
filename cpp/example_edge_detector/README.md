...
For a more general package example, see the [example_waypoint_flier](https://github.com/ctu-mrs/mrs_core_examples/tree/ros2/cpp/example_waypoint_flier).
You can test the program in simulation (see our [docs](https://ctu-mrs.github.io/docs/simulations/)).
...
For a more detailed description of good programming practices in the context of ROS, see the [example_waypoint_flier](https://github.com/ctu-mrs/mrs_core_examples/tree/ros2/cpp/example_waypoint_flier).
Also check out our general [C++ good/bad coding practices tutorial](https://ctu-mrs.github.io/docs/software/cpp/cpp_good_practices).
