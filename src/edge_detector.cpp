...
void EdgeDetector::onInit() {
  ...
  mrs_lib::ParamLoader param_loader(nh, "EdgeDetector");
  ...
  transformer_ = std::make_unique<mrs_lib::Transformer>("EdgeDetector");
...
PLUGINLIB_EXPORT_CLASS(vision_example::EdgeDetector, nodelet::Nodelet);
